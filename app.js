//näitab sõna, kus tühikud on alakriipsudega asendatud
const wordDiv = document.getElementById("word");
const scoreDiv = document.getElementById('score');
const alphabet = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', 'ü', 'õ', 'ö', 'ä'];
...
//kuulab klaviatuuri sisendeid
document.addEventListener("keydown", e => {
    let letter = e.key;
    if (alphabet.includes(letter) && !guessedLetters.includes(letter) && score != 0) { //kui tahed on 0 siis rohkem ei saa lisada

        guessedLetters.push(letter); //ei lase vale mitu korda vajutada
